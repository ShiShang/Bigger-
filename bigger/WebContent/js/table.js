...
$(function(){
    ...
    function add(){
      ...
      $.each(data,function(i, v){
        $("<tr  id='tr'>").attr("index",i).html("<td contenteditable='true' data-role='name' id='date'>"+v.name + "</td>" + "<td contenteditable='true' data-role='sex'  id='price'>" + v.sex + "</td>" + "<td contenteditable='true' data-role='age' id='fee'>" +v.age + "</td>" + "<td contenteditable='true' data-role='tel' id='from'>"+ v.tel + "</td>" + "<td><button class='btn btn-danger btn-sm'>删除</button></td>").insertBefore("tr:last");
      })
      saveData(data);
    }
